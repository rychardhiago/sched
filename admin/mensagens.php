...
<html>
<head>
<title>Sched Administração | Mensagens </title>
					...
					<!-- //header-ends -->
						<div class="outter-wp">
                                                ...
                                                <div class="compose-mail-box">
                                                    ...
                                                    <div class="panel-body">
                                                        <form id="formcadastro" class="com-mail">
                                                            <span class="soedicao">
                                                                De: <select class="form-control1 control3" name="remetenteid" id="remetenteid" placeholder="Remetente" disabled></select>
                                                            </span>
                                                            <span class="socadastro">
                                                                Para: <select class="form-control1 control3" name="destinatarioid" id="destinatarioid" required>
                                                                      </select>
                                                            </span>

                                                            Assunto: <input type="text" class="form-control1 control3 desabilitar" name="assunto" id="assunto" placeholder="Assunto" required>
                                                            Mensagem: <textarea rows="6" class="form-control1 control2 desabilitar" name="mensagem" id="mensagem" placeholder="Mensagem" required></textarea>
                            ...
                            <div id="divtable" class="table-responsive">
                                <table id="tabela_dados" class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-bSortable="true">Dt de envio</th>
                                        <th data-bSortable="true">Dt de leitura</th>
                            ...
                            <script type="text/javascript">
                                var classe = 'mensagens';
                                var divresposta = '#resposta';
                                var campos = 'mensagenid, profissionais.nome as nome, assunto, dtenvio, dtleitura';
                                var alias = 'destinatario';
                                var tabela = 'profissionais';
                                var inner = '';
                                var campo = 'remetenteid';
                                ...
                                var consulta = 'consultaI';
                                       ...
                                       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                           <div class="modal-dialog">
                                               <div class="modal-content">
                                                   <div class="modal-header">
                                                       <button id="btnfecharcadastro" type="button" class="close second" data-dismiss="modal" aria-hidden="true">×</button>
...
<script src="js/bootstrap.min.js"></script>
   ...
   <script type="text/javascript">
       ...
       preencher('destinatarioid', 'profissionais','profissionaiid','nome',1);
       preencher('remetenteid', 'profissionais','profissionaiid','nome',1);
