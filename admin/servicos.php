...
<html>
<head>
<title>Sched Administração | Serviços </title>
					...
					<!-- //header-ends -->
						...
						************CONTEDUO AQUII **********
                                                ...
                                                <div class="compose-mail-box">
                                                    ...
                                                    <div class="panel-body">
                                                        <form id="formcadastro" method="post">
                                                            <input type="hidden" id="servicoid" name="servicoid" class="classeid" value="0">
                                                            Empresa <select name="empresaid" id="empresaid" class="form-control1 control3">

                                                            </select>
                                                            Nome <input type="text" name="nome" id="nome" maxlength="55" placeholder="Nome" required="" class="form-control1 control3"><br>
                                                            Preço <input type="number" name="preco" id="preco" step="any" min="1" placeholder="Preço" required="" class="form-control1 control3"><br>
                                                            Tempo <input type="time" name="tempo" id="tempo" id="uf" placeholder="Tempo 00:00:00" required="" class="form-control1 control3"><br>
                                                            Descrição <textarea name="descricao" id="descricao" rows="6" class="form-control1 control2" maxlength="500" placeholder="Descrição"></textarea><br>
                            ...
                            <div id="divtable" class="table-responsive">
                                <table id="tabela_dados" class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-bSortable="true">Tempo</th>
                            ...
                            <script type="text/javascript">
                                ...
                                var campos = 'servicoid, nome, empresas.nomefantasia as empresa, tempo';
                                var alias = '';
                                var inner = 'empresas';
...
<script src="js/bootstrap.min.js"></script>
   ...
   <script type="text/javascript">
       ...
       preencher('empresaid','empresas','empresaid','nomefantasia',2);
   </script>
