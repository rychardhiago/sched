					...
					<!-- //header-ends -->
						<div class="outter-wp">
                                                ...
                                                <div class="compose-mail-box">
                                                    ...
                                                    <div class="panel-body">
                                                        <form id="formcadastro" class="com-mail">
                                                            ...
                                                            Tipo: <select type="text" class="form-control1 control3 desabilitar" name="tipo" id="tipo" required>
                                                            ...
                                                            <input id="enviar" type="submit" value="Enviar" class="">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="divtable" class="table-responsive">
                                <table id="tabela_dados" class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-bSortable="true">Data Cadastro</th>
                            ...
                            <script type="text/javascript">
                                ...
                                var campos = 'chamadoid,assunto,datacadastro,situacao';
                                var alias = 'profissionai';
                                var tabela = '';
                                var inner = '';
                                var campo = '';
                                var campoI = '';
