...
<html>
<head>
<title>Sched Administração | Países </title>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        <input type="hidden" id="paisid" name="paisid" class="classeid" value="0">
                                        Nome <input type="text" name="nome" id="nome" maxlength="55" placeholder="Nome" required=""><br>
                                        Sigla <input type="text" name="sigla" id="sigla" maxlength="2" placeholder="Sigla" required=""><br>
                        ...
                        <table id="tabela_dados" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-bSortable="true">Sigla</th>
