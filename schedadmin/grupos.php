...
<html>
<head>
<title>Sched Administração | Grupos </title>
...
<script type="text/javascript">
    ...
    var campos = 'grupoid, nomefantasia as nome, cgc';
    var alias = '';
    var inner = '';
    var campoI = '';
</script>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        <input type="hidden" id="grupoid" name="grupoid" class="classeid" value="0">
                                        ...
                                        Motivo Bloqueio<textarea name="motivobloqueio" id="motivobloqueio" placeholder="Motivo bloqueio">
                                        </textarea>
                        ...
                        <table id="tabela_dados" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-bSortable="true">Nome fantasia</th>
