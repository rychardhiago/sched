...
<html>
<head>
<title>Sched Administração | Estados </title>
...
<script type="text/javascript">
    ...
    var campos = 'estadoid, estados.nome as nome, uf, pais.nome  as pais';
    var alias = '';
    var inner = 'pais';
    var campoI = 'paisid';
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        <input type="hidden" id="estadoid" name="estadoid" class="classeid" value="0">
                                        Nome <input type="text" name="nome" id="nome" maxlength="55" placeholder="Nome" required=""><br>
                                        UF <input type="text" name="uf" id="uf" maxlength="2" placeholder="UF" required=""><br>
                                        País <select name="paisid" id="paisid" class="">
                        ...
                        <table id="tabela_dados" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-bSortable="true">UF</th>
                                    <th data-bSortable="true">País</th>
...
<script>
    preencher('paisid','pais','paisid','nome');
</script>
