...
<html>
<head>
<title>Sched Administração | Cidades </title>
...
<script type="text/javascript">
    ...
    var campos = 'cidadeid, cidades.nome as nome, estados.nome as estado';
    var alias = '';
    var inner = 'estados';
    var campoI = 'estadoid';
</script>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        <input type="hidden" id="cidadeid" name="cidadeid" class="classeid" value="0">
                                        Nome <input type="text" name="nome" id="nome" maxlength="55" placeholder="Nome" required=""><br>
                                        Estado <select name="estadoid" id="estadoid" class="">
                        ...
                        <table id="tabela_dados" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-bSortable="true">Estado</th>
...
<script>
    preencher('estadoid','estados','estadoid','nome');
</script>
