...
<html>
<head>
<title>Sched Administração | Usuários </title>
...
<script type="text/javascript">
    ...
    var campos = 'usuarioid, nome, grupo';
    var alias = '';
    var inner = '';
    var campoI = '';
</script>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        <input type="hidden" id="usuarioid" name="usuarioid" class="classeid" value="0">
                                        ...
                                        Senha <input type="password" name="senha" id="senha" maxlength="10" placeholder="Senha" required=""><br>
                                        <select name="grupo" id="grupo" class="">
