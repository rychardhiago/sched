                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body signup-block">
                                    <form id="cadastro" method="post">
                                        ...
                                        Preço <input type="number" name="preco" id="preco" step="any" min="1" placeholder="Preço" required=""><br>
                                        Tempo <input type="time" name="tempo" id="tempo" id="uf" placeholder="Tempo 00:00:00" required=""><br>
                                        Descrição <textarea name="descricao" id="descricao" maxlength="500" placeholder="Descrição"></textarea><br>
